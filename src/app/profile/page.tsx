        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            <div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Preferred LLM Provider</label>
                <select
                ...
                {profile && (
                  <div className="mt-2 text-sm text-gray-500">
                    API Keys configured: 
                    {profile.hasApiKeys.anthropic && <span className="ml-1 text-green-600">Anthropic</span>}
                    {profile.hasApiKeys.openai && <span className="ml-1 text-green-600">OpenAI</span>}
                    {!profile.hasApiKeys.anthropic && !profile.hasApiKeys.openai && (
                      <span className="ml-1 text-yellow-600">None (using local processing)</span>
                    )}
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                  />
                  <label htmlFor="agentNotifications" className="ml-2 block text-sm text-gray-900">
